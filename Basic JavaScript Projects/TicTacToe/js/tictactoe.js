...
function placeXOrO(squareNumber){
    ...
    function computersTurn(){
        ...
        let success = false;
        // This variable stores a rando m number between 0-8
        let pickASquare;
        ...
        while (!success){
            ...
            if (placeXOrO(pickASquare)){
                ...
                // This changes our booleawn and ends the loop
                success = true;
            };
        }
    }
...
//This function parses the selectedSquares array to search for win condtiions.
...
function checkWinConditions(){
    ...
    //This condition checks for a tie. If none of the baove conditions are met and 9 squares are selected, the code executes
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2){
    ...
    // This line indicates where teh start of a lines x axis is
    let x1 = coordX1,
    ...
    function animateLineDrawing(){
        ...
        if (x1 <= x2 && y1 <= y2){
            ...
            // This is necessary for the 642 win conditions
